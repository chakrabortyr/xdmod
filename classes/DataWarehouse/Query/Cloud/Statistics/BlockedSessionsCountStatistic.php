...
*/
class BlockedSessionsCountStatistic extends \DataWarehouse\Query\Cloud\Statistic
{
    ...
    {
        return 'The total number of sessions that were ended while still blocking resources on a cloud resource. A session is blocking resources when paused, suspended, or powered off on a cloud resource.<br/>
